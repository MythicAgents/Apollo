...
#if MIMIKATZ || RUN || SHELL || POWERPICK || PSINJECT || EXECUTE_ASSEMBLY || ASSEMBLY_INJECT || SHINJECT || LIST_INJECTION_TECHNIQUES || GET_INJECTION_TECHNIQUE || SET_INJECTION_TECHNIQUE || METERPRETER
