...
#if DEBUG
#if HTTP
        public static string StagingRSAPrivateKey = "USpLhDmfp4bEPl35AWb060i+6BA/0ERAfG4GYAN1OBk=";
#elif SMB
...
#endif
#if HTTP
        public static string PayloadUUID = "34404749-5334-40d1-a12a-6b5320b32635";
#elif SMB
