...
#if DEBUG
#if HTTP
        public static string StagingRSAPrivateKey = "HmgIsEcfSwV128YEJzqF6qc1dsVUYJmypTuM9nJk45E=";
#elif SMB
...
#endif
#if HTTP
        public static string PayloadUUID = "f919c9d9-bfee-46fe-9784-8e2239fe3877";
#elif SMB
