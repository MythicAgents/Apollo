...
#if DEBUG
#if HTTP
        public static string StagingRSAPrivateKey = "zxnFB89AXen+E7FkvKKiup+1cuYEBHOsrLQ+k2gIqTY=";
#elif SMB
...
#endif
#if HTTP
        public static string PayloadUUID = "f5336e5d-85a8-4030-b230-050c10a793fb";
#elif SMB
