...
#if DEBUG
#if HTTP
        public static string StagingRSAPrivateKey = "HDZ2fp3CLEHrRRdyTaFD+4/YERydVh7I83V0FsuGyFs=";
#elif SMB
...
#endif
#if HTTP
        public static string PayloadUUID = "ba282ad1-0430-440b-b6a5-1475725bed9c";
#elif SMB
