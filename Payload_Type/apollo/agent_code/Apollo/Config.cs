...
#if DEBUG
#if HTTP
        public static string StagingRSAPrivateKey = "wTFslJ3IF9WOQznmyWgLb6e7I6SQH2DyucZVz8krm0g=";
#elif SMB
...
#endif
#if HTTP
        public static string PayloadUUID = "f64700b7-9622-408f-afb3-12eb98e3be67";
#elif SMB
