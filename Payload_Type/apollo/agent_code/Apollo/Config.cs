...
#if HTTP
        public static string StagingRSAPrivateKey = "Tx5UCgqR1ApBfh/O2Tel1+T5FCa/RwS8H0pV8XXTBeo=";
#elif SMB
...
#endif
#if HTTP
        public static string PayloadUUID = "b4ca59b4-2b1a-4c64-8559-d6a1d4006212";
#elif SMB
